defmodule RumblWeb.VideoControllerTest do
  ...
  describe "with a logged-in user" do
    ...
    @tag login_as: "johansen"
    test "lists all user's videos on index", %{conn: conn, user: user} do
      user_video = video_fixture(user, title: "funny cats")
      other_video = video_fixture(user_fixture(username: "otheruser"), title: "another video")
  ...
  test "authorizes actions against access bu other users", %{conn: conn} do
